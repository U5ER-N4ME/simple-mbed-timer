...
Timer t; // a timer to count time

// Using 4041BH-33 (common cathode)
//                     A    B    C    D    E    F    G
BusOut segments_anode(p10, p11, p12, p13, p14, p15, p16);
//                      0    1    2    3
...
void displayBit(ushort bit, ushort number, ushort time)
{
    ...
    switch (number)
    {                                         // GFE DCBA
        case 0: segments_anode = 0x40; break; // 100 0000, 0
        case 1: segments_anode = 0x79; break; // 111 1001, 1
        case 2: segments_anode = 0x24; break; // 010 0100, 2
        case 3: segments_anode = 0x30; break; // 011 0000, 3
        case 4: segments_anode = 0x19; break; // 001 1001, 4
        case 5: segments_anode = 0x12; break; // 001 0010, 5
        case 6: segments_anode = 0x02; break; // 000 0010, 6
        case 7: segments_anode = 0x78; break; // 111 1000, 7
        case 8: segments_anode = 0x00; break; // 000 0000, 8
        case 9: segments_anode = 0x10; break; // 001 0000, 9
        case 10:segments_anode = 0x3F; break; // 011 1111, -
    }
    wait_ms(time);
